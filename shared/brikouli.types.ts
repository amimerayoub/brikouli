...
export type Gig = { id: string; employerId: string; title: string; description: string; category: string; city: string; neighborhood: string | null; latitude: number | null; longitude: number | null; payment: number; paymentType: PaymentType; duration: string; status: GigStatus; createdAt: string };
